...
def main():
    ...
    for i in range(len(style_images)):
        ...
        style_images[i] = skimage.transform.resize(style_images[i], (style_scale * target_shape[0] / style_images[i].shape[0], style_scale * target_shape[1] / style_images[i].shape[1]))
