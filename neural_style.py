...
def main():
    ...
    for i in range(len(style_images)):
        ...
        style_images[i] = skimage.transform.resize(style_images[i], (int(math.floor(float(style_scale * target_shape[0] / style_images[i].shape[0]))), int(math.floor(float(style_scale * target_shape[1] / style_images[i].shape[1])))
